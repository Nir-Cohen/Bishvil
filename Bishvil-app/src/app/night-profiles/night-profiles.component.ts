...
@Component({
  selector: 'app-night-profiles',
  templateUrl: './night-profiles.component.html',
  styleUrls: ['./night-profiles.component.css']
})
export class NightProfilesComponent implements OnInit {
