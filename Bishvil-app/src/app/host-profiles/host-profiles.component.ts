...
@Component({
  selector: 'app-host-profiles',
  templateUrl: './host-profiles.component.html',
  styleUrls: ['./host-profiles.component.css']
})
export class HostProfilesComponent implements OnInit {
